export const SINGNUP_REQUEST = Symbol('SIGNUP_REQUEST');
export const SINGNUP_SUCCESS = Symbol('SIGNUP_SUCCESS');
export const SINGNUP_FAILURE = Symbol('SIGNUP_FAILURE');
